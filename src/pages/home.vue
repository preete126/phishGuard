<template>
    <v-main class="bg pa-3">
        <div class="d-flex ga-3 align-center">
            <h1 class="text-h3 text-sm-h2 font-weight-black">PhishGuard</h1>
            <v-icon size="50">mdi-shield-check</v-icon>
        </div>
        <p class="mx-auto mb-5 text-h6 w-sm-75 text-center">Stay Safe Online – Instantly Detect Malicious and Phishing
            Links</p>
        <v-card class="py-5 px-2 pa-sm-7 w-100 w-md-75">
            <!-- <v-card-item> -->
                <v-card-title class="text-center mb-2 text-wrap">Check If a URL is Safe or a Phishing
                    Trap</v-card-title>
    ...
    <v-main class=" w-100 layout pa-5 mx-auto mb-15">
        <h2 class="text-center mb-10 mb-sm-15 text-h5 text-sm-h4 font-weight-black">Common Types of Dangerous Links You
            Should Avoid</h2>
        <v-row class="gap">
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-web</v-icon>
                <p class="mt-5 font-weight-black text-h6">Deceptive Websites</p>
            ...
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-link-variant-remove</v-icon>
                <p class="mt-5 font-weight-black text-h6">Suspicious Shortened Links</p>
        ...
        <v-row class="gap my-10">
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-login-variant</v-icon>
                <p class="mt-5 font-weight-black text-h6">Fake Login Pages</p>
                <p class="mt-5">These pages mimic real websites and ask for login credentials. Once you enter them,
                    hackers gain access to your accounts. Always check the website’s URL and use two-factor
                    authentication for extra security.</p>
            </v-col>
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-bug-outline</v-icon>
                <p class="mt-5 font-weight-black text-h6">Malware-Infested Links</p>
                <p class="mt-5">These links lead to downloads that install viruses, spyware, or ransomware on your
                    device. Avoid clicking on links from unknown sources, and ensure your antivirus software is
                    up-to-date.</p>
            </v-col>
        </v-row>
        <v-row class="gap my-10">
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-file-alert-outline</v-icon>
                <p class="mt-5 font-weight-black text-h6">Phishing Links</p>
                <p class="mt-5">Phishing links aim to steal your personal and financial information. These links are
                    often
                    disguised as legitimate emails or websites and ask for sensitive data. Always verify the source and
                    never provide personal information through untrusted links.</p>
            </v-col>
            <v-col cols="12" sm="" class="bg-surface pa-5 rounded-lg">
                <v-icon color="red-lighten-3" size="40">mdi-virus</v-icon>
                <p class="mt-5 font-weight-black text-h6">Virus and Trojan Links</p>
                <p class="mt-5">These links often lead to downloads that infect your device with malicious software like
                    ...
                    prompt
                    you to download files.</p>
            </v-col>
        </v-row>
    </v-main>
    <v-main class="mt-0 mt-sm-15 bg-surface pa-5 pt-15">
        <div class="w-100 layout mx-auto mb-15">
            <h1 class="text-center text-h5 text-sm-h4 font-weight-black mb-5 mb-sm-10">How to Stay One Step Ahead of
                Cyber Threats</h1>
...
<style scoped>
.bg {
    background: linear-gradient(180deg, #0A192F 65%, white 0%);
    color: white;
